...
全局搜索可以查找应用、文件以及受支持应用中的内容。

| 搜索对象 | 支持的操作 |
|:--|:--|
| 已安装的应用 | 直接打开应用 ｜
| 启用了全文搜索的目录 | 按文件名或文件内容搜索并访问目录中的文件 |
| 文件管理器中的其他目录 | 按文件名搜索并访问目录中的文件 |
| 团队共享文件 | 按文件名搜索并访问团队成员与你共享的文件 |
| 文件管理器中的同步磁盘 | 按文件名搜索并访问目录中的文件 |
| Wise 阅读器 | 按名称搜索 RSS 订阅、网页和 PDF 等内容 |
| **更多内容** |  |
| 设置  | 调整 Olares 外观设置 |

### 配置文件搜索规则

默认情况下，全局搜索中所有文件**只能通过文件名**进行搜索。  

...
你可以直接在应用市场购买付费应用。支付过程需要结合电脑端操作、LarePass 手机端验证以及加密货币钱包（如 MetaMask）共同完成。
...
- **LarePass 手机端**：手机上已安装 LarePass 应用，并登录了与电脑端一致的账户。

### 第一步：发起购买与身份验证

1. 打开 Olares **应用市场**。
2. 搜索目标付费应用，点击**获取**，然后点击**购买**。
3. 此时电脑端会出现**验证支付访问权限**弹窗，点击**立即验证**。

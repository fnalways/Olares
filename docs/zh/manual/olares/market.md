...
如果你是在当前的 Olares 系统中重装已卸载的付费应用，系统会保留你的应用许可证。你可以在应用市场找到该应用，点击 **获取**，然后点击 **安装** 即可重新安装。
...
3. 搜索目标付费应用，点击 **获取**，然后点击 **购买**。
    ...
    ：：：
4. 在电脑端出现的 授权支付访问弹窗中，点击 立即验证。

    ：：：tip说明：此步骤旨在验证你的身份所有权，而非发起新的交易请求。
    ：：：
...
- 重新获取许可证需要通过开发者的Merchant进行签发，如果开发者的Merchant服务不可用，你同样可能无法恢复购买的应用。
：：：

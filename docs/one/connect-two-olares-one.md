...
5. Run the add node command. Ensure the `--version` matches the version found in the pre-check output (e.g., `1.12.3`):
...
6. Perform the same installation and activation steps for the worker node.

---
outline: [2, 3]
description: View the component layout and detailed hardware specifications of Olares One.
---
...
![Olares One back view](../public/images/one/olares-one-backview.png#bordered){width="80%"}
...
| Memory | 96 GB (2 x 48 GB) DDR5 5600 MHz |
| Storage | 2 TB NVMe SSD PCIe 4.0 |
| Wireless | Wi-Fi 7 & Bluetooth® 5.4 |
| I/O ports | <ul><li>1 x 2.5 G Ethernet</li><li>1 x Thunderbolt™ 5</li><li>1 x HDMI 2.1</li><li>1 x USB 3.2</li><li>1 x Power Port</li></ul> |
| Chassis | Aluminum alloy shell with a plastic base |
| Dimensions | 320 × 197 × 55 mm |
| Power adapter | 330 W |
